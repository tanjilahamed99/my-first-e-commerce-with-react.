...
const Shirt = ({ shirt, handleCart }) => {
    const { image, Brand, Size, Price, Stock,SKU } = shirt
    return (
        <div className='border-2 shadow-md shadow-gray-500 text-center p-5'>
            ...
            <div className='space-y-2 mt-3'>
                ...
                <button onClick={() => handleCart(shirt, Price,SKU)} className='btn btn-primary bg-purple-700 text-white'>Add To Cart</button>
            </div>
        </div>
    );
};
